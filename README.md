...
[Click here for a full app example](https://crunkstar.github.io/dayspan-vuetify-next/example/)
...
Install with `npm install --save dayspan-vuetify-next`

**This library works best with Vuetify >= 1.1.9**

```javascript
import DaySpanVuetify from 'dayspan-vuetify-next'
...
Checkout [dayspan-vuetify-next-example](https://github.com/crunkstar/dayspan-vuetify-next-example) for an example of a calendar app which saves events to localStorage.
...
import 'dayspan-vuetify-next/dist/lib/dayspan-vuetify-next.min.css'
...
This library supports multiple locales but the build only comes with [en-us/en](https://github.com/crunkstar/dayspan-vuetify-next/blob/master/src/locales/en.js). The following code shows you how to add locales, changing the current locale, and updating a given locale:
...
```javascript
import fr from 'dayspan-vuetify-next/src/locales/fr';
import Vue from 'vue';
// dayspan-vuetify-next should already be loaded at this point
...
```javascript
import nl from 'dayspan-vuetify-next/src/locales/nl';
import Vue from 'vue';
// dayspan-vuetify-next should already be loaded at this point
...
```javascript
import de from 'dayspan-vuetify-next/src/locales/de';
import Vue from 'vue';
// dayspan-vuetify-next should already be loaded at this point
...
```javascript
import ca from 'dayspan-vuetify-next/src/locales/ca';
import Vue from 'vue';
// dayspan-vuetify-next should already be loaded at this point
